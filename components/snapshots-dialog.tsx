...
export function SnapshotsDialog({ repositoryId, repositoryName, open, onOpenChange }: SnapshotsDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="md:max-w-[95vw] w-full h-[85vh] p-0 gap-0 overflow-hidden flex flex-col bg-background/95 backdrop-blur-xl border-border/50 shadow-2xl">
                ...
                <div className="flex flex-1 h-full overflow-hidden">
                    {/* LEFT SIDEBAR */}
                    {sidebarOpen && (
                        <div className="w-[280px] border-r border-border/40 flex flex-col bg-muted/10 shrink-0 h-full">
                    ...
                    <div className="flex-1 bg-background flex flex-col min-w-0 overflow-hidden relative">
                         ...
                         <div className="h-14 border-b border-border/40 flex items-center px-4 gap-4 bg-background/95 backdrop-blur shrink-0 z-20">
                             <button
