...
function useSidebar() {
  ...
  if (!context) {
    // Return a safe fallback for components used outside SidebarProvider (e.g. Header)
    return {
      state: "expanded",
      open: true,
      setOpen: () => {},
      openMobile: false,
      setOpenMobile: () => {},
      isMobile: true, // Force "mobile" behavior to make dropdowns open to "bottom" instead of "right"
      toggleSidebar: () => {},
    }
  }
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="rounded-r-xl bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          "group-data-[resizing=true]:transition-none group-data-[resizing=true]:duration-0",
